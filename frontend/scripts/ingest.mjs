...
const DATA_DIR = path.resolve(ROOT, value('data', '../data/linkedin/05_2026'));
const PEOPLE_CSV = path.resolve(ROOT, value('people', '../data/roster/people.csv'));
const CLASSES_CSV = path.resolve(ROOT, value('classes', '../data/roster/classes.csv'));
const STUDENTS_CSV = path.resolve(ROOT, value('students', '../data/roster/students.csv'));
const CAS_CSV = path.resolve(ROOT, value('cas', '../data/roster/cas.csv'));
const OVERRIDES_CSV = path.resolve(ROOT, value('overrides', '../data/roster/overrides.csv'));
